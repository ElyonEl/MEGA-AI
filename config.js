...
const defaultOwner = '22891384535';
...
//
global.botname = process.env.BOTNAME || 'Mr MASK';
global.pairingNumber = process.env.BOT_NUMBER || '22891384535' ;  // put your number here
global.SESSION_ID = process.env.SESSION_ID || '' ;  // put your session id here

global.mods = []
global.prems = []
global.allowed = ['22891384535']
